            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-6 col-sm-12">
                    <ul class="breadcrumb float-md-right">
                        ...
                        <li class="breadcrumb-item active">Sector/Group/Sub Group</li>
                    </ul>
                </div>
            </div>
        </div>
                            ...
                            <div class="body">
                                <form class="form-horizontal __search">
                                    ...
                                    <div class="btn-control">
                                        ...
                                        <a class="btn btn-raised btn-default __gold waves-effect" href="/MasterAddEdit">เพิ่มใหม่</a>
                                    </div>
                                </form>
                        ...
                        <div class="card">
                            <div class="header">
                                <div class="header-status">
                                    <h3>Sector / Group / Sub Group เพิ่มล่าสุดทั้งหมด</h3>
                                    <span>2,240</span>
                                </div>
                            ...
                            <div class="body table-responsive company-list">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>1</td>
                                            <td>ไพรเวท คอมพานี</td>
                                            <td>โฮลดิ้งส์</td>
                                            <td>-</td>
                                            <td>-</td>
                                            <td>-</td>
                                            <td>-</td>
                                            <td><a href="/MasterAddEdit"><button type="button" class="btn btn-raised btn-default waves-effect"> <i class="material-icons">mode_edit</i></button></a></td>
                                        </tr>
                                        <tr>
                                            <td>1</td>
                                            <td>ไพรเวท คอมพานี</td>
