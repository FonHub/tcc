                            ...
                            <div class="body">
                                <form class="form-horizontal __search">
                                    ...
                                    <div class="btn-control">
                                        ...
                                        <a class="btn btn-raised btn-default __gold waves-effect" href="/stockMarketAddEdit">เพิ่มใหม่</a>
                                    </div>
                                </form>
                        ...
                        <div class="card">
                            ...
                            <div class="body table-responsive company-list">
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                            <th style="width:60px;">Symbol Code</th>
                                            <th>Date</th>
                                            <th>บริษัทเจ้าของหุ้น(Company)</th>
                                            <th>บริษัทผู้ถือหุ้น (Company)</th>
                                            <th>Currency</th>
                                            <th>Market</th>
                                            <th>ทุนจดทะเบียน</th>
                                            <th>หุ้นทั้งหมด</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>บอจ</td>
                                            <td>200</td>
                                            <td><a href="/stockMarketAddEdit"><button type="button" class="btn btn-raised btn-default waves-effect"> <i class="material-icons">mode_edit</i></button></a></td>
                                        </tr>
                                        <tr>
                                            <td>123</td>
                                            <td>วัน-เดือน-ปี พ.ศ.</td>
